...
void show_best_goalscorer_order(listateam );
void show_best_goalscorer(listateam );
void recursive(listateam , team [], int , int , int );
...
void ordenate_recursive(listateam , team [], int , int , int );
...
int main(){
 ...
 do{
   ...
   switch(opcion){
      ...
      case 11: show_best_goalscorer_order(list);
               break;

      case 12: show_best_goalscorer(list);
               break;
      ...
      case 19: load_goalscorer(&list, &t);
               break;
